...
Tags: pool, football, prediction, competition, world cup, qatar, champions league, fantasy football, sports
...
If you have a custom translation, you can put the translation files in the plugin-dir, but be careful they don't get overwritten with an update of the plugin. So, I also support that you put the translation file in a sub folder (named 'football-pool') of the `WP_LANG_DIR`. Make sure you name the mo-file right: **football-pool-aa_BB.mo** (where aa_BB is your language code).
...
A big shout-out to all the <a href="https://translate.wordpress.org/projects/wp-plugins/football-pool/contributors/">translation contributors and editors</a> that helped translating the plugin sofar. Thank you!
